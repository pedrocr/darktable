...
{
#ifdef USE_LUA
  dt_lua_register_module_member(darktable.lua_state,self,dt_imageio_latex_t,filename,char_path_length);
  dt_lua_register_module_member(darktable.lua_state,self,dt_imageio_latex_t,title,char_1024);
#endif
}
void*
