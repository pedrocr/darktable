...
void gui_init(dt_iop_module_t *self)
{
  ...
  g_object_set (G_OBJECT(g->profile),  "tooltip-text", _("profile used for variance stabilization"), (char *)NULL);
  g_object_set (G_OBJECT(g->mode),     "tooltip-text", _("method used in the denoising core. non-local means works best for `lightness' blending, wavelets work best for `color' blending"), (char *)NULL);
  g_object_set (G_OBJECT(g->radius),   "tooltip-text", _("radius of the patches to match. increase for more sharpness"), (char *)NULL);
