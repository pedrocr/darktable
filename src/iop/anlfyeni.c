...
void gui_init(struct dt_iop_module_t *self)
{
  ...
  g_object_set (G_OBJECT(g->scale1), "tooltip-text", _("sensitivity of edge detection"), (char *)NULL);
  ...
  g_object_set (G_OBJECT(g->scale2), "tooltip-text", _("spatial extent of the effect around edges"), (char *)NULL);
  ...
  g_object_set (G_OBJECT(g->scale3), "tooltip-text", _("strength of the local contrast"), (char *)NULL);
